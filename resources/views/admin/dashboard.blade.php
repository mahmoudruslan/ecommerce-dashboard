                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="small font-weight-bold">{{ __('Accepted Orders') }} <span
                                class="float-left">{{ $data['percentage_of_acceptance'] }}</span> ({{__('Number') . ' : ' . $data['acceptance_count']}}) </h4>
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar"
                                style="width: {{ $data['percentage_of_acceptance'] }}" aria-valuenow="100" aria-valuemin="0"
                                aria-valuemax="100"></div>
                        </div><br>
                        <h4 class="small font-weight-bold">{{ __('Rejected Orders') }} <span
                                class="float-left">{{ $data['rejection_percentage'] }}</span> ({{__('Number') . ' : ' . $data['rejection_count']}}) </h4>
                        ...
                        <h4 class="small font-weight-bold">{{ __('Failed Orders') }} <span
                                class="float-left">{{ $data['failure_percentage'] }}</span> ({{__('Number') . ' : ' . $data['failure_count']}}) </h4>
                        <div class="progress mb-4">
                        ...
                        <h4 class="small font-weight-bold">{{ __('Delivery') }} <span
                            class="float-left">{{ $data['percentage_of_delivery'] }}</span> ({{__('Number') . ' : ' . $data['delivery_count']}}) </h4>
                    <div class="progress mb-4">
                    ...
                    <h4 class="small font-weight-bold">{{ __('Successfully delivered') }} <span
                        class="float-left">{{ $data['percentage_of_successfully_delivered'] }}</span> ({{__('Number') . ' : ' . $data['successfully_delivered_count']}}) </h4>
                <div class="progress mb-4">
                    <div class="progress-bar bg-success" role="progressbar"
                        style="width: {{ $data['percentage_of_successfully_delivered'] }}" aria-valuenow="20" aria-valuemin="0"
                        aria-valuemax="100"></div>
                </div>
