...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer('admin.dashboard', function ($view) {
            ...
            $data['delivery_count'] = count(Order::where('status', 3)->get());
            $data['successfully_delivered_count'] = count(Order::where('status', 4)->get());
            ...
            $view->with([
                ...
                // 'percentage_of_acceptance' => $percentage_of_acceptance,
                // 'percentage_of_delivery' => $percentage_of_delivery,
                // 'percentage_of_successfully_delivered' => $percentage_of_successfully_delivered,
            ]);
        });
    }
}
